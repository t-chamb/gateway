...
func (in *PeeringEntry) DeepCopyInto(out *PeeringEntry) {
	*out = *in
	...
	if in.Ingress != nil {
		...
		*out = make([]PeeringEntryIngress, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PeeringEntryIngress) DeepCopyInto(out *PeeringEntryIngress) {
	*out = *in
	if in.Allow != nil {
		in, out := &in.Allow, &out.Allow
		*out = new(PeeringEntryIngressAllow)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PeeringEntryIngress.
func (in *PeeringEntryIngress) DeepCopy() *PeeringEntryIngress {
	if in == nil {
		return nil
	}
	out := new(PeeringEntryIngress)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PeeringEntryIngressAllow) DeepCopyInto(out *PeeringEntryIngressAllow) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PeeringEntryIngressAllow.
func (in *PeeringEntryIngressAllow) DeepCopy() *PeeringEntryIngressAllow {
	if in == nil {
		return nil
	}
	out := new(PeeringEntryIngressAllow)
