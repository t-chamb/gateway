...
// +kubebuilder:webhook:path=/mutate-gateway-githedgehog-com-v1beta1-peering,mutating=true,failurePolicy=fail,sideEffects=None,groups=gateway.githedgehog.com,resources=peerings,verbs=create;update;delete,versions=v1beta1,name=mpeering.kb.io,admissionReviewVersions=v1
// +kubebuilder:webhook:path=/validate-gateway-githedgehog-com-v1beta1-peering,mutating=false,failurePolicy=fail,sideEffects=None,groups=gateway.githedgehog.com,resources=peerings,verbs=create;update;delete,versions=v1beta1,name=vpeering.kb.io,admissionReviewVersions=v1
